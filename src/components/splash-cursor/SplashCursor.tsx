...
export default function SplashCursor({
  ...
  // Helper to convert hex to RGB (supports 3, 6, and 8 digits)
  ...
  useEffect(() => {
    ...
    function generateColor(): ColorRGB {
      if (SPLASH_COLORS && SPLASH_COLORS.length > 0) {
        const randomHex = SPLASH_COLORS[Math.floor(Math.random() * SPLASH_COLORS.length)];
